      ...
      "https://api.groq.com/openai/v1/chat/completions",
      {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "system",
              content: `Data Usage Rules:
1. NEVER guess, estimate, or invent prices/fabrics. Only use the exact data provided below in OFFICIAL ATELIER CATALOG & PRICING DATA.
2. When asked about a specific tier (bridal, party wear, casual, consultation), reference only that tier's data from the catalog below.
3. If asked for an overview of all services, summarize all tiers using the catalog data provided.
4. Price Guardrail Check: Never quote a Bridal piece under PKR 180,000 — cross-check against the catalog data.,
            ${catalogContext}`,
            },
            ...sanitizedMessages,
          ],
